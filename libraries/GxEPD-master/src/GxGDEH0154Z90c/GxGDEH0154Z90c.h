...
#ifndef _GxGDEH0154Z90c_H_
#define _GxGDEH0154Z90c_H_

#include "../GxEPD.h"

#define GxGDEH0154Z90c_WIDTH 160
#define GxGDEH0154Z90c_HEIGHT 160

#define GxGDEH0154Z90c_BUFFER_SIZE (uint32_t(GxGDEH0154Z90c_WIDTH) * uint32_t(GxGDEH0154Z90c_HEIGHT) / 8)

// divisor for AVR, should be factor of GxGDEH0154Z90c_HEIGHT
#define GxGDEH0154Z90c_PAGES 10

#define GxGDEH0154Z90c_PAGE_HEIGHT (GxGDEH0154Z90c_HEIGHT / GxGDEH0154Z90c_PAGES)
#define GxGDEH0154Z90c_PAGE_SIZE (GxGDEH0154Z90c_BUFFER_SIZE / GxGDEH0154Z90c_PAGES)

class GxGDEH0154Z90c : public GxEPD
{
  public:
    static const bool usePartialUpdateWindow = false; // needs be false, controller issue
#if defined(ESP8266)
    //GxGDEH0154Z90c(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    // use pin numbers, other ESP8266 than Wemos may not use Dx names
    GxGDEH0154Z90c(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    GxGDEH0154Z90c(GxIO& io, int8_t rst = 9, int8_t busy = 7);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDEH0154Z90c_PAGES times
  ...
  private:
#if defined(__AVR)
    uint8_t _black_buffer[GxGDEH0154Z90c_PAGE_SIZE];
    uint8_t _red_buffer[GxGDEH0154Z90c_PAGE_SIZE];
#else
    uint8_t _black_buffer[GxGDEH0154Z90c_BUFFER_SIZE];
    uint8_t _red_buffer[GxGDEH0154Z90c_BUFFER_SIZE];
#endif
    GxIO& IO;
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDEH0154Z90c
#define GxEPD_WIDTH GxGDEH0154Z90c_WIDTH
#define GxEPD_HEIGHT GxGDEH0154Z90c_HEIGHT
#define GxEPD_BitmapExamples <GxGDEH0154Z90c/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxGDEH0154Z90c/BitmapExamples.h"
#endif
